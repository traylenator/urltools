...
def test_parse():
    ...
    assert parse("http://example.ac.at") == ('http', '', '', '', 'example', 'ac.at', '', '', '', '','http://example.ac.at')
    ...
    assert parse("http://[::1]/foo/bar") == ('http', '', '', '', '[::1]', '', '', '/foo/bar', '', '','http://[::1]/foo/bar')
    assert parse("[::1]/foo/bar") == ('', '', '', '', '', '', '', '[::1]/foo/bar', '', '','[::1]/foo/bar')
...
def test_extract():
    ...
    assert extract("http://example.com?foo=bar:blub") == ('http', '', '', '', 'example', 'com', '', '', 'foo=bar:blub', '','http://example.com?foo=bar:blub')
    assert extract("http://example.com?foo=bar:blub/") == ('http', '', '', '', 'example', 'com', '', '', 'foo=bar:blub/', '','http://example.com?foo=bar:blub/')
    ...
    assert extract("http://[::1]/foo/bar") == ('http', '', '', '', '[::1]', '', '', '/foo/bar', '', '','http://[::1]/foo/bar')
    assert extract("[::1]/foo/bar") == ('', '', '', '', '[::1]', '', '', '/foo/bar', '', '','[::1]/foo/bar')
